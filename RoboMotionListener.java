...
public class RoboMotionListener extends Listener {
    ...
    public void onConnect(Controller controller) {
        ...
        nxtRoboController = new NXTRoboController() ; 
        ...
        for (int i = 0; i < gestures.count(); i++) {
            ...
            case TYPE_CIRCLE:
                ...
                if (circle.pointable().direction().angleTo(circle.normal()) <=
                    ...
                    // Call clockwise() in NXTRoboController ;
                    nxtRoboController.turnClockwise();
                    
                } else {
                                   nxtRoboController.turnCounterClockwise();
                }
                ...
                if (circle.state() != State.STATE_START) {
                    ...
                    sweptAngle =
                            (circle.progress() - previousUpdate.progress()) *
                            2 * Math.PI;
                }
            ...
            case TYPE_SWIPE:
                ...
                System.out.println("Swipe id: " + swipe.id() + ", " +
                                   ...
                                   swipe.speed());
                if (swipe.startPosition() - swipe.position() > 0 ) {
                    nxtRoboController.moveForward();
                }
                else {
                    nxtRoboController.moveBackward();
                }
                break;
